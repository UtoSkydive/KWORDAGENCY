...
const Footer = ({ footerSetting = {} }) => {
    ...
    return (
        ...
        <path fill="#1e3868" fill-opacity="1" d="M0,64L34.3,85.3C68.6,107,137,149,206,170.7C274.3,192,343,192,411,181.3C480,171,549,149,617,165.3C685.7,181,754,235,823,256C891.4,277,960,267,1029,272C1097.1,277,1166,299,1234,272C1302.9,245,1371,171,1406,133.3L1440,96L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"></path>
      </svg>
